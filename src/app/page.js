    ...
    <main>
      ...
      <footer className='my-20 flex justify-center items-center flex-col mx-[15vmin]'>
        ...
        <div className='mt-6 '>
          ...
          <Image className='rounded-full ' width={150} height={150} src={"https://instagram.fhyd11-1.fna.fbcdn.net/v/t51.2885-19/448204358_984593266446026_7952747744001668548_n.jpg?stp=dst-jpg_s150x150&_nc_ht=instagram.fhyd11-1.fna.fbcdn.net&_nc_cat=102&_nc_ohc=DAiNExA7ByIQ7kNvgGGn69d&edm=AEhyXUkBAAAA&ccb=7-5&oh=00_AYCgtNrlSnG5K0Wfgwyre_8P9919veQu7B9qm5WT4TQnKg&oe=66A575DE&_nc_sid=8f1549"}/>
          <div className='w-1/2'>
